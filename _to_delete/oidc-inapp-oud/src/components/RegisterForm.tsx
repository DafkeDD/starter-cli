...
import { Btn, Field, Input } from '@/components/ui/primitives'
...
export function RegisterForm({ uid, brand, error }: { uid: string; brand: string; error?: string }) {
    const base = `{{MOUNT}}/interaction/${encodeURIComponent(uid)}`
    ...
    return (
        <div className='auth-card fade-in'>
            ...
            <a href={base} className='btn btn-ghost btn-lg btn-block'>
